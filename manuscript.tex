...
inhomogeneous plasma and magnetic fields have shed light on the eigenmode
...
alpha-particles, Maxwellian electrons and Maxwellian majority
...
velocity parallel to the magnetic field $u_\parallel$, the shift of the
...
k_\bot \simeq 13\; \Omega_{i}/V_A)$.
Qualitatively, scattered points in Fig.
\ref{fig:2D_F12_physicalpitch}(a) resemble the experimental observations given
by the black trace in that the
signal below the $7^{th}$ cyclotron harmonic is lower and flatter with well
defined peaks and the signal beyond the $7^{th}$ harmonic is a step-change
larger and the harmonics are less easily identifiable. These features cannot
be recreated with a 1D calculation for these distribution functions
...
\includegraphics[scale=0.9]{fig5.pdf}
    ...
    Eq. \ref{eqn:fastalfven} (Eq. 25 of Ref. \cite{Dendy1994},
...
for large $k_\parallel$ is comparable in magnitude to the alpha-particle cyclotron
frequency making it difficult to determine which parts of the signal come
from which cyclotron harmonic numbers. This has important implications for
